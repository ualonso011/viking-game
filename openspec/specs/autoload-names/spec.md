# Autoload Names Specification

## Purpose

Define the canonical naming convention for autoload singleton references in GDScript, ensuring consistency between `project.godot` registrations and code-level access.
